...
class Panel_Window_Empleado(ft.View):
    ...
    def mostrarProductosSeleccionados(self):
        pass
    ...
    def consulta(self,e):
        ...
        productosCategoria = consultarProductosFiltros(nombre=nombreProducto,categoria=categoria,marca=marca,
                                                       precio_min=precioMin,precio_max=precioMax,stock_min=stockMin,
                                                       stock_max=stockMax)
        self.cargarProductos(productos=productosCategoria)
